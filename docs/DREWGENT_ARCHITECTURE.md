...
Drewgent is a personal AI agent system built on the opencode platform. It combines multiple specialized modules (VerificationEngine, GrowthEngine, RevisionLoop, AutoLearner) into a unified agent that runs as a Docker-based service.
