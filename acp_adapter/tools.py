"""ACP tool-call helpers for mapping drewgent tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map drewgent tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a drewgent tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given drewgent tool invocation."""
