#!/usr/bin/env python3
"""
SWE Runner with Drewgent Trajectory Format

A runner that uses Drewgent-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Drewgent-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Drewgent-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Drewgent format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Drewgent-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Drewgent-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Drewgent Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Drewgent-Agent's built-in execution environments
    and outputs trajectories in Drewgent-Agent format.
    """
    ...
    def _convert_to_drewgent_format(
        self,
        ...
        """
        Convert internal message format to Drewgent trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Drewgent trajectory format
        trajectory = self._convert_to_drewgent_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Drewgent trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Drewgent Trajectory Format")
    print("=" * 60)
