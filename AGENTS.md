...
| 08:00 / 15:00 | **content-curator** 🆕 | content_curator.py ($0, Python) — 모든 소스 heuristic curation → kanban INSERT |
| 12:00 / 20:00 | **content-editor** | opencode run (agent) — draft → publish QA |
