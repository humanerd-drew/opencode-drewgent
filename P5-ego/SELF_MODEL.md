...
links:
  ...
  - "[[P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/禁kanban_hallucination.neuron]]"
...
### Core Identity
- [[P1-limbic/persona/SOUL]] — P1-Limbic identity and voice (who Drewgent is)
- [[P1-limbic/persona/writing-style-guide]] — Korean writing style guide for blog content (Drewgent P1-limbic tone)

### Architecture & Data Flow
- [[P3-sensors/gateway/drewgent-architecture-dataflow]] — **End-to-end data flow**: full message lifecycle (Platform → Gateway → AIAgent → Platform), session/memory flow, file reference table with line numbers
...
- [[P4-cortex/plans/stabilization_report]] — Drewgent runtime stabilization report (P0-brainstem import fix, launchd label fix)

### Content & Automation
- [[P4-cortex/knowledge/laws-of-ux-wiki/index]] — Laws of UX knowledge wiki (external-link content, graph excluded)

### Planning & Memory
- [[P6-prefrontal/plans/growth-2026]] — Drewgent growth plan 2026 (skills, memory, automation goals)
- [[P6-prefrontal/migrations/drewgent-root-consolidation-20260506]] — 2026-05-06 root consolidation migration (canonical runtime, quarantine)
