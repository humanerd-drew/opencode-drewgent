...
Include **Mermaid diagrams** inline for architecture/flow visualization. Quartz at YOUR_DOMAIN renders them automatically.
...
Design rules (YOUR_DOMAIN dark theme):
...
**Blog post** (long-form for YOUR_DOMAIN):
```markdown
---
