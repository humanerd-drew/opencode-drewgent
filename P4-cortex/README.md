...
Learning, pattern recognition, content production, and taste development. Runtime data lives here and is **not** committed to git (see `.gitignore`).
...
- `P2-hippocampus/` — memory and knowledge storage
- `skills/software-development/` — development skills
- `skills/creative/` — content production skills
