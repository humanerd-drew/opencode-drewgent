...
links:
  ...
  - "[[P0-brainstem/brain/Loragent-brain/P0-brainstem/禁/禁brain_obsidian_graph.neuron]]"  # graph rule
---
```
...
### Group A: .neuron files (10 files in P0-brainstem/brain/Loragent-brain/P0-brainstem/)
...
| 禁karpathy_coding_principles.neuron | 禁karpathy_coding_principles | Loragent P0-brainstem |
...
| 禁tool_integration_3file.neuron | 禁tool_integration_3file | Loragent P5-Ego Integration |

### Group B: .neuron files (4 files in P0-brainstem/brain/Loragent-brain/P0-brainstem/禁/)

| File | Rule Token | Source |
|------|-----------|--------|
| 禁brain_obsidian_graph.neuron | 禁brain_obsidian_graph | Loragent P5-Ego + P0-brainstem |
| 禁kanban_hallucination.neuron | 禁kanban_hallucination | Loragent Brain Integration |
| 禁kanban_worker_accountability.neuron | 禁kanban_worker_accountability | Loragent Brain Integration |
| 禁task_qa_gate.neuron | 禁task_qa_gate | Loopy-Era HARD Hooks |
...
```json
{"id": "禁auto_validate", "type": "policy", "space": "policy", "title": "禁auto_validate", "file": "P0-brainstem/brain/Loragent-brain/P0-brainstem/禁auto_validate.neuron", "links": ["rules", "SELF_MODEL", "禁brain_obsidian_graph"]}
...
- [[P4-cortex/growth/loragent-kanban-implementation-plan]] — kanban patterns (related to kanban rules)
