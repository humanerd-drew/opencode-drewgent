...
## Drewgent Pilot: What Was Applied
...
**Group A (10개)**: `P0-brainstem/brain/Drewgent-brain/P0-brainstem/`
...
**Group B (4개)**: `P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/`
...
| rule_token | Drewgent native | 고유 규칙 식별자 |
| rule_priority | Drewgent native | P0 (HIGHEST) |
| rule_source | Drewgent native | 규칙 출처 |
| created | Drewgent native | 생성일 |
| updated | Drewgent native | 수정일 |
| promotion_status | Drewgent native | validated / draft / deprecated |
| links | Drewgent native | wikilink 연결 목록 |

### space 분류 (현재)

Drewgent Pilot Phase 1에서는 모든 P0 규칙을 `space: policy`로統一.
...
# 3. orphan .neuron 없음
for f in ~/.drewgent/P0-brainstem/brain/Drewgent-brain/P0-brainstem/*.neuron; do
...
- [[P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/禁brain_obsidian_graph.neuron]] — Graph integrity rule
