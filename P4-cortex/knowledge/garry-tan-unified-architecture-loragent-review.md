---
title: Garry Tan Unified Architecture Loragent Review
status: published
type: concept
space: concept
...
## 7개 시리즈 종합 분석 + Loragent 보완 제안

**Author**: Garry Tan (Y Combinator CEO)
**Series**: 7개 기사 (2026년 4월~5월)
**Target**: Loragent Architecture Review
...
| 항목 | Garry Architecture | Loragent 현재 | 상태 |
|------|-------------------|--------------|------|
| Fat Skills | markdown procedures | `~/.loragent/skills/*.md` | ✅ 완료 |
...
- [[P0-brainstem/brain/Loragent-brain/P0-brainstem/禁/禁task_qa_gate.neuron]] — P0 brain rule
