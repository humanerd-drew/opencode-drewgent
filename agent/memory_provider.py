...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - drewgent_home (str): The active DREW_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.drewgent``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "drewgent").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'drewgent memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], drewgent_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'drewgent memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``drewgent_home`` is the active DREW_HOME directory path.
