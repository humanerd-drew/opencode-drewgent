...
def _get_token_dir() -> Path:
    ...
    Uses DREW_HOME so each profile gets its own OAuth tokens.
...
class DrewgentTokenStorage:
    ...
    File layout::
        ...
        DREW_HOME/mcp-tokens/<server_name>.json         -- tokens
        DREW_HOME/mcp-tokens/<server_name>.client.json   -- client info
    """
