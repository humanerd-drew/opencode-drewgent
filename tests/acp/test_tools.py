...
COMMON_DREW_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_drewgent_tools_have_kind(self):
        """Every common drewgent tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_DREW_TOOLS:
