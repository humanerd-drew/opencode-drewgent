...
class TestParserRegistry:
    ...
    def test_drewgent_parser_registered(self):
        parsers = list_parsers()
        assert "drewgent" in parsers
...
# ─── Drewgent parser tests ────────────────────────────────────────────────

class TestDrewgentParser:
    @pytest.fixture
    def parser(self):
        return get_parser("drewgent")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["drewgent"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use drewgent format since that's universal
