...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because drewgent uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("DREW_GATEWAY_SESSION", "1")
        monkeypatch.delenv("HERMES_EXEC_ASK", raising=False)
...
class TestScheduleCronjob:
    ...
    def test_thread_id_captured_in_origin(self, monkeypatch):
        ...
        monkeypatch.setenv("DREW_SESSION_CHAT_ID", "123456")
        monkeypatch.setenv("DREW_SESSION_THREAD_ID", "42")
