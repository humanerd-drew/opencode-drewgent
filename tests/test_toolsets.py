...
class TestToolsetConsistency:
    ...
    def test_drewgent_platforms_share_core_tools(self):
        """All drewgent-* platform toolsets should have the same tools."""
        platforms = ["drewgent-cli", "drewgent-telegram", "drewgent-discord", "drewgent-whatsapp", "drewgent-slack", "drewgent-signal", "drewgent-homeassistant"]
