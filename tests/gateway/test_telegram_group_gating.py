...
def _make_adapter(require_mention=None, free_response_chats=None, mention_patterns=None):
    ...
    adapter._bot = SimpleNamespace(id=999, username="drewgent_bot")
...
def _mention_entity(text, mention="@drewgent_bot"):
...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @drewgent_bot", entities=[_mention_entity("hi @drewgent_bot")])) is True
