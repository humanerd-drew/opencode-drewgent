...
def session_db(tmp_path):
    ...
    os.environ["DREW_HOME"] = str(tmp_path / ".hermes")
...
def cli_instance(tmp_path, session_db):
    """Create a minimal DrewgentCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        DrewgentCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        DrewgentCLI._handle_branch_command(cli_instance, "/branch refactor approach")
    ...
    def test_fork_alias(self):
        ...
        from drewgent_cli.commands import resolve_command
...
class TestBranchCommandDef:
    ...
    def test_branch_in_registry(self):
        ...
        from drewgent_cli.commands import COMMAND_REGISTRY
