...
File: `~/.{{AGENT_NAME_LOWER}}/agents/content-manager.md`
...
Full content: see `~/.{{AGENT_NAME_LOWER}}/agents/content-manager.md`.
...
- **Paths must be absolute.** Use `~/.{{AGENT_NAME_LOWER}}/P2-hippocampus/memories/insights/`, not relative paths.
