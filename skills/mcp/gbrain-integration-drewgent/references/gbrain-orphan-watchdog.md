...
```
PID 29420 ← 게이트웨이 ({{AGENT_NAME_LOWER}}_cli.main gateway)    ← 유지
...
- Gateway parent → KEEP (`{{AGENT_NAME_LOWER}}_cli.main gateway run`)
...
**스크립트:** `~/.hermes/scripts/{{AGENT_NAME_LOWER}}_gbrain_watchdog.sh`
