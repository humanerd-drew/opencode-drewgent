...
# SEO + GEO Audit — YOUR_DOMAIN 감사 및 관리
...
# 전통 SEO만
python3 ~/.{{AGENT_NAME_LOWER}}/P4-cortex/scripts/seo_audit.py --modules sitemap,meta,content,links

# JSON 출력
python3 ~/.{{AGENT_NAME_LOWER}}/P4-cortex/scripts/seo_audit.py --output seo-20260522.json
```
...
python3 ~/.{{AGENT_NAME_LOWER}}/P4-cortex/scripts/seo_audit.py \
  --output ~/.{{AGENT_NAME_LOWER}}/P6-prefrontal/logs/seo-geo-audit-$(date +%Y%m%d).json
```
...
## Related
- [[skills/YOUR_SITE]] — site management
