...
grep -n "import json\|import os, json" ~/.loragent/source/loragent-agent/run_agent.py
...
" ~/.loragent/source/loragent-agent/run_agent.py

# _json_mod 잔여 확인
grep -n "_json_mod" ~/.loragent/source/loragent-agent/run_agent.py
```
