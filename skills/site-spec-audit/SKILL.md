...
```
url = 인자 또는 기본값 "https://YOUR_DOMAIN"
...
각 spec 항목에 대해 YOUR_DOMAIN에서 검증:
...
1. Quartz 빌드
2. YOUR_DOMAIN 라이브 URL에 spec check 적용
