...
ULTRAPLINIAN_MODELS = [
    ...
    'nousresearch/{{AGENT_NAME_LOWER}}-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'nousresearch/{{AGENT_NAME_LOWER}}-4-70b',
    'z-ai/glm-5-turbo',
    ...
    'nousresearch/{{AGENT_NAME_LOWER}}-4-405b',
    # POWER TIER (39-49)
    'nousresearch/{{AGENT_NAME_LOWER}}-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
