...
| **Copying without understanding** | AgentsRoom layout (multi-agent grid) forced onto single-agent system | Tab-based layout adapted to {{AGENT_NAME}}'s actual architecture |
...
## AgentsRoom vs {{AGENT_NAME}}: Honest Comparison

| Capability | AgentsRoom | {{AGENT_NAME}} | Why {{AGENT_NAME}} Can't |
|---|---|---|---|
...
The key: build what fits {{AGENT_NAME}}'s architecture, not what looks cool in another product.
