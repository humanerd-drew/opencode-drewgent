...
updated: 2026-05-20
links:
  - "[[@memory/growth/open-crab-ontology-{{AGENT_NAME_LOWER}}-implementation]]"
...
## Script Location
```
~/.{{AGENT_NAME_LOWER}}/P4-cortex/scripts/ontology_query.py
```
...
Links FROM 禁karpathy_coding_principles:
  → P0-brainstem/brain/{{AGENT_NAME}}-brain/P0-brainstem/禁/禁brain_obsidian_graph
...
## Ontology File
```
~/.{{AGENT_NAME_LOWER}}/P0-brainstem/p0-brain-ontology.jsonl
```
13 nodes exported as JSONL. Updated manually when new .neuron files are created.

## Related
- [[@memory/growth/open-crab-ontology-{{AGENT_NAME_LOWER}}-implementation]] — Phase 1+2 implementation report
- [[@memory/knowledge/OPENCRAB_ONTOLOGY]] — 9-Space mapping to {{AGENT_NAME}} P-layers
