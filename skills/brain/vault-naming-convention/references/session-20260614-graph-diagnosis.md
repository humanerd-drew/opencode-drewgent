...
- Total files: ~9,600
- Total size: ~45MB
- Hub nodes: `loragent-kanban-implementation-plan` (11,576 hits), `kanban-orchestrator` (11,565), `kanban-dashboard` (11,564)
...
| SCHEMA.md | 3 | Nested ~/.loragent/~/.loragent/ moved to .trash. Source copy excluded. |
...
2. Renamed root SOUL.md → HERMES_SYSTEM_PROMPT.md (Hermes system prompt, not Loragent identity)
3. Renamed docker/SOUL.md → DOCKER_PERSONA.md
4. Moved nested ~/.loragent/~/.loragent/ to .trash/
...
| P3-sensors/gateway/loragent-architecture-dataflow.md | 8 | 9 | NEURONFS_RULES |
