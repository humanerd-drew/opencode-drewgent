...
{{AGENT_NAME}} manages credentials using pass-zero: a GPG-free encrypted store.

## Architecture

```
~/.{{AGENT_NAME_LOWER}}/.master_pass          ← Master key (NOT synced to cloud)
SynologyDrive-{{AGENT_NAME_LOWER}}/{{AGENT_NAME_LOWER}}/secrets/  ← Encrypted .enc files (synced)
  github/token.enc
  github/username.enc
...
python3 ~/Library/CloudStorage/SynologyDrive-{{AGENT_NAME_LOWER}}/{{AGENT_NAME_LOWER}}/secrets/pass-zero.py get <service> <key>

# Store a secret
python3 ~/Library/CloudStorage/SynologyDrive-{{AGENT_NAME_LOWER}}/{{AGENT_NAME_LOWER}}/secrets/pass-zero.py set <service> <key> "<value>"

# List services
python3 ~/Library/CloudStorage/SynologyDrive-{{AGENT_NAME_LOWER}}/{{AGENT_NAME_LOWER}}/secrets/pass-zero.py services

# List keys in a service
python3 ~/Library/CloudStorage/SynologyDrive-{{AGENT_NAME_LOWER}}/{{AGENT_NAME_LOWER}}/secrets/pass-zero.py list <service>
```
...
Replace the credential value in `~/.{{AGENT_NAME_LOWER}}/config.yaml` at the relevant path.
