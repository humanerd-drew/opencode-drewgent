...
updated: 2026-05-20
links:
  - "[[P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/禁auto_validate.neuron]]"
  - "[[P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/禁brain_obsidian_graph.neuron]]"
  - "[[P0-brainstem/brain/Drewgent-brain/P0-brainstem/禁/禁subagent_verify.neuron]]"
...
# Drewgent 아키텍처 — 데이터 흐름(Data Flow) 문서

**생성일**: 2026-05-13
**Updated**: 2026-05-13 (P0-brainstem enforcement layer)
**Target**: Drewgent Agent 전체 데이터 흐름을 모든 레이어에서 추적 가능하게 함
...
ArchitectureModel (P4-cortex evaluation via P3-sensors processing):
    ...
    SLASH_COMMAND_FILES = ["drewgent_cli/commands.py", "cli.py"]
...
gateway/run.py — GatewayRunner (8,652 lines)
    ...
    │
    ├── hooks: DrewgentHooks (lifecycle events)
    │
...
- [[P3-sensors/gateway/platforms/ADDING_A_PLATFORM]] — How to add a new platform adapter to Drewgent gateway
