...
trigger: "After trend-harvester job completes, before brain-growth-001"
space: outcome
type: document
tags: [growth, memory, sync, P2, P4, harvester]
links:
  - "[[P3-sensors/skills/brain/DESCRIPTION]]"
  - "[[P3-sensors/skills/SKILL-INDEX]]"
source: Loragent P4→P2 pipeline, Loopy-Era integration
---
...
- Track synced hashes in `loragent_hidden_state.json["harvester_synced_hashes"]`

## State Tracking

Read/write from `P4-cortex/knowledge/loragent_hidden_state.json`:
