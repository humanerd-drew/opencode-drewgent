...
# ── Config ──────────────────────────────────────────────────────────────────
VAULT         = Path("/Volumes/loragent_storage/_agent/MEMORY")
...
SCAN_DIRS = [
    ("brain/",          3.0),   # highest: Loragent brain rules
...
CHANNEL_DIR       = Path.home() / ".loragent" / "channel_directory.json"
THREAD_STATE_FILE = Path.home() / ".loragent" / "discord_threads.json"
...
**Auto-generated by Loragent Session Archiver**  
