...
space: outcome
type: document
links: [[P3-sensors/skills/SKILL-INDEX]]]
...
Before Loragent declares "done", Harsh Critic asks:
...
All checks logged to `~/.loragent/harsh_critic_log.jsonl`:
...
| Purpose | Path |
|---------|------|
| Plugin | `~/.loragent/plugins/loopy-era-harness/` |
| Hard gates | `~/.loragent/plugins/loopy-era-harness/__init__.py` |
| Log | `~/.loragent/harsh_critic_log.jsonl` |
| Rules | `~/.loragent/rules/` |
