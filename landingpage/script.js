...
const PLATFORMS = {
  linux: {
    command:
      "curl -fsSL https://raw.githubusercontent.com/YOUR_ORG/hermes-agent/main/scripts/install.sh | bash",
    prompt: "$",
...
const demoSequence = [
  ...
  {
    type: "type",
    text: "Review the PR at YOUR_ORG/hermes-agent#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
