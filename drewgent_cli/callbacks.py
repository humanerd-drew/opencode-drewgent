...
into prompt_toolkit's event loop. Each function takes the DrewgentCLI instance
...
from drewgent_cli.banner import cprint, _DIM, _RST
from drewgent_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.drewgent/.env and never exposed to the model.
    """
