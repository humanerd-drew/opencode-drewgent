...
Usage:
    drewgent pairing list              # Show all pending + approved users
    drewgent pairing approve <platform> <code>  # Approve a pairing code
    drewgent pairing revoke <platform> <user_id> # Revoke user access
    drewgent pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle drewgent pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: drewgent pairing {list|approve|revoke|clear-pending}")
        print("Run 'drewgent pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'drewgent pairing list' to see pending codes.\n")
