...
def select_provider_and_model(args=None):
    ...
    top_providers = [
        ("nous", "Nous Portal (Your Organization subscription)"),
...
def _update_via_zip(args):
    ...
    branch = "main"
    zip_url = f"https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME/archive/refs/heads/{branch}.zip"
...
OFFICIAL_REPO_URLS = {
    "https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME.git",
    "git@github.com:YOUR_GITHUB_USER/YOUR_REPO_NAME.git",
    "https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME",
    "git@github.com:YOUR_GITHUB_USER/YOUR_REPO_NAME",
}
OFFICIAL_REPO_URL = "https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from YOUR_GITHUB_USER/YOUR_REPO_NAME.")
        print()
        try:
        ...
        if response in ("", "y", "yes"):
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print("  ✓ Added upstream: https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME.git")
                has_upstream = True
            else:
                print("  ✗ Failed to add upstream remote. Skipping upstream sync.")
                return
        else:
            print("  Skipped. Run 'git remote add upstream https://github.com/YOUR_GITHUB_USER/YOUR_REPO_NAME.git' to add later.")
...
def cmd_update(args):
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            print("  curl -fsSL https://raw.githubusercontent.com/YOUR_GITHUB_USER/YOUR_REPO_NAME/main/scripts/install.sh | bash")
            sys.exit(1)
