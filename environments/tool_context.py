...
ALL drewgent-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all drewgent-agent tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_drewgent_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any drewgent-agent tool by name.
