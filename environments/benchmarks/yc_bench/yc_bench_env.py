...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs DrewgentAgentLoop with terminal tool only
...
Requires: pip install drewgent-agent[yc-bench]
"""
...
class YCBenchEvalConfig(DrewgentAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends DrewgentAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(DrewgentAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The DrewgentAgentLoop then drives the
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs DrewgentAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our DrewgentAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the DrewgentAgentLoop
            # ----------------------------------------------------------
