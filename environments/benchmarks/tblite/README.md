...
- **Dataset (ours):** [YOUR_ORG/openthoughts-tblite](https://huggingface.co/datasets/YOUR_ORG/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `YOUR_ORG/terminal-bench-2`  | `YOUR_ORG/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
