...
Inspired by: GroceryMind — production Drewgent agent doing live web research
             across German grocery stores (firecrawl + drewgent-agent)
"""
...
# Ensure drewgent-agent root is on path
...
class WebResearchEnvConfig(DrewgentAgentEnvConfig):
...
class WebResearchEnv(DrewgentAgentBaseEnv):
    """
