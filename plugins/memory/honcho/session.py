...
class HonchoSessionManager:
    ...
    Runs alongside Drewgent's existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = self._sanitize_id(
            self._config.ai_peer if self._config else "drewgent-assistant"
        )
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Drewgent-side char cap before caching
            if (
                result
    ...
    def get_prefetch_context(
        ...
        # Also fetch AI peer's own representation so Drewgent knows itself.
        try:
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.drewgent/memories/).
