"""
Email platform adapter for the Drewgent gateway.

Allows users to interact with Drewgent by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Drewgent Agent")
        ...
        msg_id = f"<drewgent-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
