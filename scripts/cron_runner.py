#!/usr/bin/env python3
"""
Cron Runner — every 60s by launchd/loragent-cron-runner-001.
...
- ai.loragent.cron-runner plist 부재 → 5/30 21:55부터 cron job들이 dormant.
...
# The system hermes CLI (Loragent wrapper at ~/.local/bin/hermes,
...
# ~/.loragent/kanban.db is the single source of truth.
try:
    r = subprocess.run(
        ...
        text=True,
        timeout=50,
        # Strip trailing colon from PYTHONPATH to prevent ~/.loragent
