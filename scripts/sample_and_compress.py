...
DEFAULT_DATASETS = [
    ...
    "NousResearch/loragent-agent-megascience-sft1",
    "NousResearch/Loragent-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Loragent-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-loragent-agent"
]
