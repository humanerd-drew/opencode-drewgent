...
DEFAULT_DATASETS = [
    ...
    "NousResearch/drewgent-agent-megascience-sft1",
    "NousResearch/Drewgent-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Drewgent-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-drewgent-agent"
]
