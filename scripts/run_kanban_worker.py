#!/usr/bin/env python3
"""
Kanban Worker — executes tasks from the {{AGENT_NAME}} kanban board.
...
DREW_HOME = Path(os.environ.get("DREW_HOME", Path.home() / ".{{AGENT_NAME_LOWER}}"))
SRC_AGENT = DREW_HOME / "source" / "{{AGENT_NAME_LOWER}}-agent"
DB_PATH = DREW_HOME / "P2-hippocampus" / "kanban" / "state" / "{{AGENT_NAME_LOWER}}_tasks.db"
