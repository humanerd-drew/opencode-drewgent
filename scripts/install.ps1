...
#
# Usage:
#   irm https://raw.githubusercontent.com/YOUR_ORG/hermes-agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:YOUR_ORG/hermes-agent.git"
$RepoUrlHttps = "https://github.com/YOUR_ORG/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Write-Banner {
    ...
    Write-Host "├─────────────────────────────────────────────────────────┤" -ForegroundColor Magenta
    Write-Host "│  An open source AI agent by Your Organization.              │" -ForegroundColor Magenta
    Write-Host "└─────────────────────────────────────────────────────────┘" -ForegroundColor Magenta
    Write-Host ""
}
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/YOUR_ORG/hermes-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/YOUR_ORG/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
