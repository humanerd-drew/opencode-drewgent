...
Drewgent Agent includes a full environment framework that connects its tool-calling capabilities to the [Atropos](https://github.com/YOUR_ORG/atropos) RL training framework. This enables three workflows:
...
Dataset: [YOUR_ORG/terminal-bench-2](https://huggingface.co/datasets/YOUR_ORG/terminal-bench-2) on HuggingFace.
...
TBLite is a thin subclass of TerminalBench2 — only the dataset and timeouts differ. Created by the OpenThoughts Agent team (Snorkel AI + Bespoke Labs). Dataset: [YOUR_ORG/openthoughts-tblite](https://huggingface.co/datasets/YOUR_ORG/openthoughts-tblite).
...
env:
  ...
  dataset_name: "YOUR_ORG/terminal-bench-2"
...
- Python >= 3.11
- `atroposlib`: `pip install git+https://github.com/YOUR_ORG/atropos.git`
